        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuccessfulOrderCount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsNewRelease = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountCode = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    ...
                    ClaimCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    TransactionId = table.Column<string>(type: "text", nullable: false),
                    ClaimCodeUsedByStaffId = table.Column<string>(type: "text", nullable: false),
                    IsClaimCodeUsed = table.Column<bool>(type: "boolean", nullable: false),
                    ClaimCodeUsedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ReceivedVolumeDiscount = table.Column<bool>(type: "boolean", nullable: false),
                    ReceivedLoyaltyDiscount = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ClaimCodeUsedByStaffId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookAwards", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitDiscount = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ClaimCodeUsedByStaffId",
                table: "Orders",
