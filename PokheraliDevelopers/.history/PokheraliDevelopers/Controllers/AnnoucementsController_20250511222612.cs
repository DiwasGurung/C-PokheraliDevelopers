    ...
    public class AnnouncementsController : ControllerBase
    {
        ...
        public async Task<ActionResult<AnnouncementDto>> CreateAnnouncement([FromBody] CreateAnnouncementDto createAnnouncementDto)
        {
            ...
            var announcement = new Announcement
            {
                ...
                StartDate = createAnnouncementDto.StartDate.ToUniversalTime(),
                EndDate = createAnnouncementDto.EndDate.ToUniversalTime(),
                IsActive = true,
        ...
        public async Task<IActionResult> UpdateAnnouncement(int id, [FromBody] CreateAnnouncementDto updateAnnouncementDto)
        {
            ...
            existingAnnouncement.StartDate = updateAnnouncementDto.StartDate.ToUniversalTime();
            existingAnnouncement.EndDate = updateAnnouncementDto.EndDate.ToUniversalTime();
