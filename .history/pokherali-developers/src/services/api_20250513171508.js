...
export const announcementService = {
  getActiveAnnouncement: () => axios.get('/api/announcements/active'),
  getAnnouncements: () => axios.get('/api/announcements'),
  createAnnouncement: (data) => axios.post('/api/announcements', data),
  updateAnnouncement: (id, data) => axios.put(`/api/announcements/${id}`, data),
  deleteAnnouncement: (id) => axios.delete(`/api/announcements/${id}`),
};
