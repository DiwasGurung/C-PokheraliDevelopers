...
export default function AddBookModal({ isOpen, onClose, onSave, book }) {
  ...
  try {
    ...
    formData.append("stockQuantity", bookData.stock);
    formData.append("genre", bookData.genre);
    formData.append("isbn", bookData.isbn);
    formData.append("publisher", bookData.publisher);
    formData.append("publicationDate", bookData.publishDate ? new Date(bookData.publishDate).toISOString() : null);
    formData.append("language", bookData.language);
    formData.append("format", bookData.format);
    formData.append("pages", bookData.pages ? parseInt(bookData.pages) : null);
    formData.append("dimensions", bookData.dimensions || null);
    formData.append("weight", bookData.weight || null);
    formData.append("imageUrl", imageUrl); // Include image URL
    formData.append("discountPercentage", bookData.discountPercentage ? parseFloat(bookData.discountPercentage) : null);
    formData.append("originalPrice", bookData.originalPrice ? parseFloat(bookData.originalPrice) : null);
    formData.append("isOnSale", bookData.isOnSale);
    formData.append("isBestseller", bookData.isBestseller);
    formData.append("isNewRelease", bookData.isNewRelease);
    formData.append("discountStartDate", bookData.discountStartDate ? new Date(bookData.discountStartDate).toISOString() : null);
    formData.append("discountEndDate", bookData.discountEndDate ? new Date(bookData.discountEndDate).toISOString() : null);

    // If updating an existing book, use the PUT method
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 text-base border ${errors.title ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 text-base border ${errors.author ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500`}
                  />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 text-base border ${errors.description ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500`}
                  />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 text-base border ${errors.price ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500`}
                      placeholder="0.00"
                    />
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 text-base border ${errors.genre ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500`}
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 text-base border ${errors.dimensions ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 text-base border ${errors.weight ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500`}
                    placeholder="e.g., 0.5"
                  />
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={bookData.isbn}
                    onChange={handleChange}
                    className={`w-full px-4 py-3 text-base border ${errors.isbn ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500`}
                  />
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 text-base border ${errors.publisher ? "border-red-500" : "border-gray-300"} rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500`}
                    />
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          {errors.discountStartDate && (
                            <p className="mt-1 text-sm text-red-500">{errors.discountStartDate}</p>
                          )}
                        </div>
