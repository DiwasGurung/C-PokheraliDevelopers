    ...
    if (roles.includes("Admin")) {
      return (
        <>
          ...
          <li>
            <a href="/admin/process-claims" className="text-gray-700 hover:text-blue-600 font-medium">
              Process Claims
            </a>
          </li>
        </>
    ...
    if (roles.includes("Member")) {
      return (
        <>
          ...
          <li>
            <a href="/announcements" className="text-gray-700 hover:text-blue-600 font-medium">
              Announcement
            </a>
          </li>
        </>
